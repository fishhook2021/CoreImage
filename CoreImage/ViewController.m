...
- (void)viewDidLoad
{
    ...
    // 创建过滤器
    filter = [CIFilter filterWithName:@"CISepiaTone"];//棕黑色调
    filter2 = [CIFilter filterWithName:@"CIHueAdjust"];//饱和度调节
    filter3 = [CIFilter filterWithName:@"CIStraightenFilter"];//拉直过滤器
